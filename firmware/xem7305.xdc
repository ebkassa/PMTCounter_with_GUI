...
set_property IOSTANDARD LVCMOS25 [get_ports {lockin_inc}]
#set_property PACKAGE_PIN V5 [get_ports {c_ch1}]  #V5(MC2 PIN3 (B34_L17P )) is short, change it to V4(MC2 PIN5 (B34_L17N ))
set_property PACKAGE_PIN V4 [get_ports {c_ch1}]
set_property PACKAGE_PIN V3 [get_ports {lockin_inc}]

#set_clock_groups -asynchronous -group [get_clocks {okUH0} -group [get_clocks {clk_460MHz_clk_wiz_460mhz}]] -group [get_clocks {mmcm0_clk0}]
